...
// Tanaman Routes
router.get('/tanaman/getAllTanaman/:idUser', accessValidations,tanamanController.getAllTanaman);
...
router.get('/tanaman/getRekomendasi/:penyakit/:tanaman', accessValidations, tanamanController.getRekomendasi);
