...
router.post('/users/forgotPass', accessValidations,userController.forgotPassword);
router.get('/users/reset-password/:idUser/:token/:email', accessValidations,userController.resetPassword);
router.post('/users/reset-password/:idUser/:token/:email', accessValidations,userController.reset_password);
